...
def fig_CPT_raw_data(df_CPT):
    ...
    ax[0].plot(qc,z, '.',color='C0',alpha=al,label='qc')
    ax[0].plot(qt,z, '.', color='C1',alpha=al,label='qt')
    ax[1].plot(fs,z, '.',color='C0',alpha=al,label='fs')
    ax[2].plot(u2,z, '.',color='C0',alpha=al,label='u2')
    ax[3].plot(Rf,z, '.',color='C0',alpha=al,label='Rf')
    ax[4].plot(Bq,z, '.',color='C0',alpha=al,label='Bq')
    #
