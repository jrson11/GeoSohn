...
def clay_bearing_capacity(project):
    ...
    with col1:
        ...
        with tab1:
            ...
            with col_l3:
                Mext_B = st.number_input('Mext_B: Moment in B-axis', value = 0) # Moment in B direction (kNm)
                Mext_L = st.number_input('Mext_L: Moment in L-axis', value = 0) # Moment in L direction (kNm)
